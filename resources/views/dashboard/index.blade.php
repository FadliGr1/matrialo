            ...
            <div class="statistics-card">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn-statistics">
                        <img src="{{ asset('img/global/times.svg')}}" alt="">
                    </button>
                </div>

                <div class="statistics-list">
                    <img class="statistics-image" src="{{asset('img/home/history/photo-4.png')}}" alt="">
                    <img class="statistics-image" src="{{asset('img/home/history/photo-3.png')}}" alt="">
                    <img class="statistics-image" src="{{asset('img/home/history/photo.png')}}" alt="">
                    <img class="statistics-image" src="{{asset('img/home/history/photo-1.png')}}" alt="">
                    <img class="statistics-image" src="{{asset('img/home/history/photo-2.png')}}" alt="">
                </div>
            ...
            <div class="statistics-card">
                ...
                <div class="statistics-list">
                    <div class="statistics-icon award">
                        <img src="{{asset('img/home/team/award.svg')}}" alt="">
                    </div>
                    <div class="statistics-icon globe">
                        <img src="{{asset('img/home/team/globe.svg')}}" alt="">
                    </div>
                    <div class="statistics-icon target">
                        <img src="{{asset('img/home/team/target.svg')}}" alt="">
                    </div>
                    <div class="statistics-icon box">
                        <img src="{{asset('img/home/team/box.svg')}}" alt="">
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="statistics-card">
                ...
                <div class="statistics-list">
                    ...
                    <!-- <img src="img/home/icon-1.png" alt=""><img src="img/home/icon-2.png" alt=""><img src="img/home/icon-3.png" alt=""><img src="img/home/icon-4.png" alt=""><img src="img/home/icon-5.png" alt=""> -->
                </div>
    ...
    <div class="row mt-5">
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="document-icon box">
                            <img src="{{asset('img/home/document/archive.svg')}}" alt="">
                        </div>
                    ...
                    <button class="btn-statistics">
                        <img src="{{asset('img/global/download.svg')}}" alt="">
                    </button>
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="document-icon database">
                            <img src="{{asset('img/home/document/database.svg')}}" alt="">
                        </div>
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <div class="document-icon target">
                            <img src="{{asset('img/home/document/book-open.svg')}}" alt="">
                        </div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="document-card">
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <img class="document-icon" src="{{asset('img/home/history/photo.png')}}" alt="">
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <img class="document-icon" src="{{asset('img/home/history/photo-1.png')}}" alt="">
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <img class="document-icon" src="{{asset('img/home/history/photo-2.png')}}" alt="">
                ...
                <div class="document-item">
                    <div class="d-flex justify-content-start align-items-center">
                        <img class="document-icon" src="{{asset('img/home/history/photo-3.png')}}" alt="">
